...
class Ext:
  ...
  #   return self.root_namespace.add_func(name, returns, params)

  # def add_alias(self, new_cpp_type_name, old_cpp_type_name):
  #   return self.root_namespace.add_alias(name, new_cpp_type_name, old_cpp_type_name)
  ...
  #   kl_type_name = None,
  #   ):
  #   return self.root_namespace.add_in_place_type(
  #     cpp_type_name,
  ...
  #   forbid_copy = False,
  #   ):
  #   return self.root_namespace.add_direct_type(
  #     cpp_type_name,
  #     kl_type_name = kl_type_name,
  #     extends = extends,
  ...
  #   extends = None
  #   ):
  #   return self.root_namespace.add_wrapped_type(
  #     cpp_type_name,
  #     kl_type_name = kl_type_name,
  #     extends = extends,
  #     )
  ...
  #   kl_type_name,
  #   ):
  #   return self.root_namespace.add_kl_ext_type_alias(
  #     cpp_type_name,
  #     kl_ext_name,
  #     kl_type_name,
  #     )
  ...
  #   ):
  #   return self.root_namespace.add_enum(
  #     cpp_type_name,
  #     values,
  #     kl_type_name = kl_type_name,
