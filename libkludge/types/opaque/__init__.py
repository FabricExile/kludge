...
class OpaqueTypeInfo(TypeInfo):
  ...
  def build_codec_lookup_rules(self):
    ...
    rules["conv"]["*"] = "types/builtin/opaque/conv"
    rules["result"]["*"] = "types/builtin/opaque/result"
    rules["repr"]["*"] = "types/builtin/opaque/repr"
    return rules

class OpaqueBuiltinDecl(BuiltinDecl):
